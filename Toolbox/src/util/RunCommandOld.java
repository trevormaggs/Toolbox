 ...
 * @since 2025-07-11
 */
public final class RunCommandOld
{
     ...
     */
    private RunCommandOld(String command)
    {
     ...
     */
    private RunCommandOld addArgument(String arg)
    {
    ...
    {
        RunCommandOld rc = new RunCommandOld(command);
